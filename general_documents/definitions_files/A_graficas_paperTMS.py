...
def graficas_paper_TMS(total_BEM_atmos_cmb,total_I1_BEM_atmos_cmb,total_I2_BEM_atmos_cmb,freq_spec,T_sky_bet_total,T_load_bet_total,Tlss_1,Tlss_2,Tlss_3,Tlss_4,Gtot,Tn_tot_sky,Tn_tot_load):
    ...
    ###########............................................................########################################
    ###########............................................................########################################
    BEM_plot=total_BEM_atmos_cmb
    new_freq=freq_spec*1e9
    band_pass_prom_BEM=[]
    ...
    ax1.plot(freq_spec,T_sky_bet_total,color='skyblue',linestyle='solid')
    ...
    ax1.plot(freq_spec,T_load_bet_total,color='coral',linestyle='solid')
    ...
    plt.savefig('/home/aarriero/Documents/Angela_cmb/four_year/cap2_TOD_TMS/plots_paper/B_betas_offset_t.pdf')
    ...
    resta_loss_mean=np.mean(resta_loss/Gtot)
    resta_loss_desv=np.std(resta_loss/Gtot)

    fig, ax = plt.subplots(figsize=(10, 5))
    plt.plot(freq_spec,resta_loss/Gtot,linestyle='-',color='plum')
    ...
    plt.savefig('/home/aarriero/Documents/Angela_cmb/four_year/cap2_TOD_TMS/plots_paper/B_LOSS_T_bem_DC_exc.pdf')
    ...
    plt.tight_layout()
    plt.savefig('/home/aarriero/Documents/Angela_cmb/four_year/cap2_TOD_TMS/plots_paper/B_abs_resul_total.pdf')
    ...
    # Curvas principales
    plt.plot(freq_spec, Tn_tot_sky,
             linestyle='-',  color='skyblue')

    plt.plot(freq_spec, Tn_tot_load, 
             linestyle='-', color='coral', linewidth=1)

    plt.plot(freq_spec, total, 
    ...
    plt.savefig('/home/aarriero/Documents/Angela_cmb/four_year/cap2_TOD_TMS/plots_paper/B_Tnoise_gain_noise.pdf')
